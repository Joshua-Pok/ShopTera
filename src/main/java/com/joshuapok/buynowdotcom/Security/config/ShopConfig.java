package com.joshuapok.buynowdotcom.Security.config;

import com.joshuapok.buynowdotcom.Security.User.ShopUserDetailsService;
import com.joshuapok.buynowdotcom.Security.jwt.AuthTokenFilter;
import com.joshuapok.buynowdotcom.Security.jwt.JwtEntryPoint;
...
public class ShopConfig {
    ...
    private static final List<String> SECURED_URLS = List.of(API+"/carts/**", API+"/cartItems/**", API+"/orders/**");
